...
import org.iesalandalus.programacion.robot.modelo.RobotException;
...
public class Main {
    ...
    private static void controlarRobotDefecto() { controladorRobot = new ControladorRobot(new Robot()); }
    ...
    private static void ejecutarComando(){
        if (controladorRobot == null) {
            ...
            } catch (RobotException | IllegalArgumentException e) {
