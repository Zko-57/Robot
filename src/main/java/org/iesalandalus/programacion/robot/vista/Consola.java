...
public class Consola {
    ...
    public static void mostrarMenuPrincipal(){
        ...
        System.out.println("4: Controlar un robot indicando su zona, orientación y coordenadas");
...
public static Zona elegirZona() {
    ...
    public static char elegirComando(){
        ...
        char c;
        System.out.println("Indique el comando a ejecutar: ");
        c = Entrada.caracter();
        return  c;
    ...
    public static void despedirse() { System.out.println("¡Adios!"); }
