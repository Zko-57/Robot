...
public record Zona(int ancho, int alto) {
    ...
    public Zona() { this(ANCHO_MINIMO, ALTO_MINIMO); }
    ...
    public Coordenada getCentro() { return new Coordenada(ancho / 2 , alto / 2); }
    ...
    private boolean perteneceX( int x) { return (x >= 0) && (x < ancho);}


    private boolean perteneceY( int y) { return (y >= 0) && (y < alto);}
